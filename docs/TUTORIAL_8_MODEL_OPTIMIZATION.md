...
자세한 내용은 [tutorial 6](/resources/docs/TUTORIAL_6_CORPUS.md)을 확인하세요.
...
다음 튜토리얼에서는 [training your own embeddings](/resources/docs/TUTORIAL_9_TRAINING_LM_EMBEDDINGS.md)에 대해 살펴볼 것입니다,
