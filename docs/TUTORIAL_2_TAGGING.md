...
종종 전체 텍스트 말뭉치에 태그를 지정할 수 있습니다. 이 경우에, 당신은 말뭉치를 문장으로 나누고 통과시킬 필요가 있습니다.
...
([제로샷 튜토리얼](/docs/TUTORIAL_10_TRAINING_ZERO_SHOT_MODEL.md)로 건너뛰기)    
TARS는 임의 클래스에 대해 텍스트 분류를 수행할 수 있습니다.

## 다음

이제 텍스트를 포함하기 위해 다른 [워드 임베딩](/docs/TUTORIAL_3_WORD_EMBEDDING.md)을 사용하는 방법에 대해 알아보겠습니다.
